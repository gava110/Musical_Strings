...
# In[57]:
"""
In this part of the code we create two functions to apply stemming and lemmatization methods to the two songs chosen by the user.
Stemming is the process of producing morphological variants of a root/base word. 
Lemmatization is the process of grouping together the different inflected forms of a word so they can be analyzed as a single item. 
This is necessary to then apply jaccard similarity, which will return to the user the similarity percentage between two songs.
...
def stemming (songs):
  ...
  The implementation uses NLTK (the Natural Language Toolkit -- is a suite of open source Python module).
